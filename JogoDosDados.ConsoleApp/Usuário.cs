namespace JogoDosDados.ConsoleApp
{
    ...
    {
        public static int posicaoUsuario = 0;

        public static bool ExecutarRodadaDoUsuário()
        {
            ...
            do
            {
                ...
                MenuInicial("Usuário(a)", posicaoUsuario, Computador.posicaoComputador, Program.limiteLinhaChegada);
                ...
                {
                    Console.WriteLine();
                    Console.WriteLine($"                                           O Jogador Está na Posição: {posicaoUsuario} de {Program.limiteLinhaChegada}");
                    Console.WriteLine();
                    Console.WriteLine("------------------------------------------------------------------------------------------------------------------------");
                }
